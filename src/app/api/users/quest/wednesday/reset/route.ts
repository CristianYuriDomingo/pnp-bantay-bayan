//app/api/users/quest/wednesday/reset/route.ts
...
export async function POST(request: NextRequest) {
  console.log('🎯 Reset Wednesday progress API called');
  ...
  try {
    ...
    const { questWednesdayId } = body;

    console.log('📝 Reset quest ID:', questWednesdayId);
    ...
    await prisma.questWednesdayProgress.deleteMany({
      where: {
